...
angular.module('sign', ['ionic','ngCordova'])
.controller('con',function($scope,$window,$cordovaImagePicker, $ionicPlatform,$cordovaCamera, $cordovaDatePicker){
            $scope.sub=function(){
                var a=$scope.u;
                var b=$scope.em;
                var c=$scope.p;
    ...
    $window.location.href='../www/index.html'; 
        ...
        quality: 80            // Higher is better
          ...
          imageSrc="content://media/external/images/media/"+photo_split[1];
            ...
            console.log(imageSrc);// Print image URI
        }
    , function(error) {
